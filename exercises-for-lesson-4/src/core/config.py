...
JWT_ACCESS_TOKEN_EXPIRE_MINUTES = 15  # 15 минут (по данным из коллекции Postman)
JWT_REFRESH_TOKEN_EXPIRE_MINUTES = 60 * 24 * 30 # 30 дней (по данным из коллекции Postman)
